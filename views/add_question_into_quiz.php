...
<?php
 ...
 <td>
<a href="javascript:addquestion('<?php echo $quid;?>','<?php echo $val['qid'];?>','<?php echo $val['cid'];?>','<?php echo $val['skill_id'];?>','
<?php echo $val['sub_skill_id'];?>'); " class="btn btn-primary" id='q<?php echo $val['qid'];?>'>
<?php 
...
{
	//alert(quid+','+qid+','+cid+','+skillid+','+subskillid);
	 var did='#q'+qid;
	var formData = {quid:quid,qid:qid,cid:cid,skillid:skillid,subskillid:subskillid};
	$.ajax({
		 type: "POST",
		 data : formData,
